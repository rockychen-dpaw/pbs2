...
class BurnImplementationStateUpdateView(AjaxRequestMixin,OneToOneModelUpdateView):
    pmodel = Prescription
    ...
    def get_context_data(self,**kwargs):
        context_data = super(BurnImplementationStateUpdateView,self).get_context_data(**kwargs)
