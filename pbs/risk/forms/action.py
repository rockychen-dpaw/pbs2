...
class ActionMemberUpdateForm(forms.RequestUrlMixin,ActionCleanMixin,ActionConfigMixin,forms.ListMemberForm):
    ...
    class Meta:
        ...
        all_fields = ("risk__category","id","relevant","risk__name","details","pre_burn","day_of_burn","post_burn","relevant","delete")
        editable_fields = ("id","relevant","details","pre_burn","day_of_burn","post_burn","relevant")
        ordered_fields = ("id","relevant","risk__name","details","pre_burn","day_of_burn","post_burn","relevant","delete")

ActionListUpdateForm = forms.listupdateform_factory(ActionMemberUpdateForm,min_num=0,max_num=100,extra=0,all_buttons=[BUTTON_ACTIONS.get('back'),BUTTON_ACTIONS.get('save')],can_delete=True,can_add=False)
